...
#define NUM_MAXSIZE   32768		//максимальное значение для типа number
#define NUM_MINSIZE  -32768		//минимальное значение для типа number
...
{	
	...
	enum STDFNC { F_CONCAT, F_LENGHT, F_NOT_STD };	//стандартные функции
